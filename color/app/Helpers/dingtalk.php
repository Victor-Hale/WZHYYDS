...
if (!function_exists('dingtalk')) {
    ...
    function dingtalk(){
        $config = [
            ...
            |-----------------------------------------------------------
            */
            'corp_id' => 'ding93752768c344323bee0f45d8e4f7c288',
            ...
            */
            ...
            |-----------------------------------------------------------
            */
            'app_secret' => 'WDuQ-yAoxi6etkjnKmHpdcBC75W2DUN9lhopGDwML4PxBLzCjzcEwZ5AC9opK7aF',
       ...
       return $app = new Application($config);
    }
